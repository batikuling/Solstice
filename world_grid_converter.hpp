...
public:
    ...
    template <typename T>
    sf::Vector2<T> world_to_grid(const sf::Vector2<T>& world_position);

    template <typename T>
    sf::Vector2<T> world_to_world_topleft(const sf::Vector2<T>& world_position);

    template <typename T>
    sf::Vector2<T> grid_to_world_topleft(const sf::Vector2<T>& grid_position);

    template <typename T>
    sf::Vector2<T> grid_to_world_center(const sf::Vector2<T>& grid_position);
...
template <typename T>
sf::Vector2<T> WorldGridConverter::world_to_grid(const sf::Vector2<T>& world_position){
    return sf::Vector2<T>(int(world_position.x) / _tile_size.x, int(world_position.y) / _tile_size.y);
}


template <typename T>
sf::Vector2<T> WorldGridConverter::world_to_world_topleft(const sf::Vector2<T>& world_position){
...
template <typename T>
sf::Vector2<T> WorldGridConverter::grid_to_world_topleft(const sf::Vector2<T>& grid_position){
    return sf::Vector2<T>(int(grid_position.x) * _tile_size.x, int(grid_position.y) * _tile_size.y);
}


template <typename T>
sf::Vector2<T> WorldGridConverter::grid_to_world_center(const sf::Vector2<T>& grid_position){
